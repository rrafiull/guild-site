...
* **Innovate:** Stay at the forefront of testing technology and methodology.
...
| :--- | :--- | :--- |
| **Embedded** | QE specialists join a squad as a core member. | Long-term product delivery. |
| **Managed Service** | An end-to-end testing team manages a specific output. | Large scale migrations or legacy systems. |
| **Advisory** | High-level consulting and architectural reviews. | Project startup or process troubleshooting. |
...
* **Pillar Leads:** Deepak Garcha (Non-Functional), Elizabeth Jones & Shaun Clark (Functional)
